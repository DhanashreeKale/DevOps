...
4)	We write the test cases and executes them on our local machine. But in large organization, there are multiple test cases and multiple servers in the picture, and it is not possible to run all the test cases on our local or a same machine. Also, these test cases must be distributed across these multiple and different servers.
